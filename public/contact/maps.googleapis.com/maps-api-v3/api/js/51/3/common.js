google.maps.__gjsload__('common', function(_) {
    ...
    qga = function() {
        ...
        _.Ca(function(b) {
            ...
            if (3 != b.h) return a = b.j, a.h.kv(), _.xa(b, 0);
            _.ya(b);
            b.h = 0
        })
    };
    ...
    iha = function(a, b) {
        var c = Nq(a.h.Ad()),
            d = b.Ja.shiftKey;
        d = a.m && 1 === c.ze && a.h.Hb.Qv || d && a.h.Hb.sz || a.h.Hb.dh;
    ...
    _.xia = function(a) {
        ...
        a.Xo ? wia(this.uf) : (this.uf.style.position = "absolute", this.uf.style.left = this.uf.style.top = "0", this.uf.style.width = "100%");
        this.j = null;
        a.Mq && (this.Dg = _.Ze("DIV"), this.Dg.style.zIndex = 3, d.appendChild(this.Dg),
            $s(this.Dg), this.j = _.Ze("DIV"), this.j.style.zIndex = 4, d.appendChild(this.j), $s(this.j), a.jd && (this.Dg.style.backgroundColor = "rgba(255,255,255,0)"), this.Tf = _.Ze("DIV"), this.Tf.style.zIndex = 4, a.Xo ? (this.Dg.appendChild(this.Tf), wia(this.Tf)) : (d.appendChild(this.Tf), this.Tf.style.position = "absolute", this.Tf.style.left = this.Tf.style.top = "0", this.Tf.style.width = "100%"));
        this.Dd = d;
        this.h = c;
    ...
    _.n.md = function() {};
    _.n.nj = function() {
        if (this.h.Hb.Xx && 3 !== this.C && this.h.Hb.Xx(this.j)) return new Oq(this.h)
    };
    ...
    _.n.Ic = function(a) {
        ...
        !b && this.h.Hb.xo && this.h.Hb.xo(this.m, this.j);
        return Eq(a) ? new Oq(this.h) : new Mq(this.h, b, a.button)
    };
    _.n.nd = function() {};
    _.n.Qc = function() {};
    _.n.nj = function() {
        this.h.Hb.xo && this.h.Hb.xo(this.m, this.j);
    ...
    gr.prototype.H = function(a) {
        ...
        if (this.ownerElement.contains(this.element)) {
            ...
            var b = ir(this, document.body),
                c = a.target,
                d = xha(this, b);
            a.target === this.h ? (c = d.Qw, a = d.Zn, d = d.Jr, this.element.contains(this.m) ? (--c, 0 <= c ? hr(b[c]) : hr(b[d - 1])) : hr(b[a + 1])) : a.target === this.j ? (c = d.Zn, a = d.Jr, d = d.Rw, this.element.contains(this.m) ? (d += 1, d < b.length ? hr(b[d]) : hr(b[c + 1])) : hr(b[a - 1])) : (d = d.Zn, this.ownerElement.contains(c) && !this.element.contains(c) && hr(b[d + 1]))
        }
    };
    ...
    _.mr.prototype.cc = function(a, b, c, d, e, f, g, h) {
        ...
        l = 1 === this.C.ld && e && this.Ga.In(e) || a;
        k = this.C.mb;
